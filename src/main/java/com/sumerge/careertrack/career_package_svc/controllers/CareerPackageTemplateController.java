...
public class CareerPackageTemplateController {
    ...
    @PostMapping
    public ResponseEntity<CareerPackageTemplateResponseDTO> createCareerPackage(@RequestBody CareerPackageTemplateRequestDTO requestDTO) {
        return ResponseEntity.ok(careerPackageTemplateService.createCareerPackage(requestDTO));
    }

    @PutMapping("/{packageId}")
    public ResponseEntity<CareerPackageTemplateResponseDTO> updateCareerPackage(@PathVariable UUID packageId, @RequestBody CareerPackageTemplateRequestDTO requestDTO) {
